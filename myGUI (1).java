...
public class myGUI extends JFrame
{
   ...
   private void buildPanel()
   {
      ...
      ImageIcon deckBackIcon = new ImageIcon("cardImages/background.jpg");
      p1DB = new JLabel(deckBackIcon);
      p2DB = new JLabel(deckBackIcon);      

      //Create player labels
      p1Label = new JLabel("Player 1 Card");
      p2Label = new JLabel("Player 2 Card");
      status = new JLabel(" ");
   ...
   private class ButtonListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ...
         if(actionCommand.equals("Next fight"))
         {
            WarGame.playWar();
